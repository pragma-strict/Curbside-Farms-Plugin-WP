...
function get_order_bed(){
    ...
    if (!empty($_POST)) {
        ...
        // Clear $_POST after use to avoid form resub???
        $_POST = array();
    }
    ...
    <div class='container'>
        ...
        <hr>
        <form action='../order-bed.php' method='post'>
    ...
    if($sent) 
    {
        $content .= "<p style=color:green;>Message sent!</p>";
    }
    else  
    {
        $content .= "<p style=color:red;>Failed to send message.</p>";
    }
    return $content;
}
